        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="files.php" class="nav-item nav-link"><i class="fa fa-chart-bar me-2"></i>Files</a>
                        
                   
                    <a href="notifitacion.php" class="nav-item nav-link active"><i class="fa fa-th me-2"></i>notifications</a>
            ...
            <div class="bg-secondary rounded h-100 p-4">
                          ...
                          <h6 class="mb-4">Floating Label</h6>
                            <div class="form-floating mb-3">
                                <input type="test" class="form-control" id="floatingInput" name="title"
                            ...
                            <button class="btn btn-primary w-100 m-2" name="submit" type="submit">Send</button>

                        </div>
                          </form>
                          <?php require_once 'php/notification.php'; ?>
